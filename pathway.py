...
class Pathway:
    ...
    chemical potentials. Initialize with:

    startingstep : string
        the step from which to start all calculations, usually '1'
    startingenergy : float
        the energy of the first step, usually 0.

    after initializing, add steps to the pathway with the add_step
    function.
    """
